...
console.log(numberToInt8(3));
console.log(numberToInt32LE(3));
console.log(numberToInt64LE(3));
console.log(serializeAmount(3));
console.log(hexaNotationToInt256LE('EE00'));
